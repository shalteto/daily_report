...
def get_daily_report(task_type, task_date):
    ...
    query = "SELECT c.users, c.task_type, c.task_date, c.start_time, c.end_time, c.trap, c.trap_type, c.sex, c.size, c.weight, c.disposal, c.file_names, c.comment, c.id FROM c WHERE c.task_type = @task_type and c.task_date = @task_date"
    parameters = [
